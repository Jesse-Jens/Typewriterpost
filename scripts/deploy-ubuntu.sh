...
for url in \
  ...
  "http://127.0.0.1:8080/admin/api/tenants/default/users" \
  "http://127.0.0.1:8080/admin/tenants/default" \
  "http://127.0.0.1:8080/tenant/default" \
  "http://127.0.0.1:8080/tenant/default/login"; do
